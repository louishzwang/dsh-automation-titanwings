...
export declare function AutomationView({ t, useAutomationState, refresh, createAutomation, updateAutomation, mutateAutomation, runNow, markRunRead, loadModelCatalog, openSession, }: AutomationViewProps): JSX.Element;
